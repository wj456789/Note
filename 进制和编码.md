...
public static void main(String[] args) {
    ...
    //从0到-1，由于非符号位全部为0，已经没有东西可减，但假如我们假设从更高的位借来了一个1，这样就能让0-1=-1了
    //0->-1     0 000 0000 -> 1 111 1111
    System.out.println(Integer.toBinaryString(1));	//0000 0000 0000 0000 0000 0000 0000 0001
    System.out.println(Integer.toBinaryString(0));	//0000 0000 0000 0000 0000 0000 0000 0000
    System.out.println(Integer.toBinaryString(-1));	//1111 1111 1111 1111 1111 1111 1111 1111
    
    //不计算符号位，负数等于正数的反码加一
    System.out.println(Integer.toBinaryString(10));	//0000 0000 0000 0000 0000 0000 0000 1010
    System.out.println(Integer.toBinaryString(-10));//1111 1111 1111 1111 1111 1111 1111 0110
    
    //-1继续减，减到0后即为最小值
    System.out.println(Integer.toBinaryString(Integer.MAX_VALUE));//0111 1111 1111 1111 1111 1111 1111 1111
...
public static void main(String[] args) {
    ...
    System.out.println("二进制转最大值："+Integer.parseInt("01111111111111111111111111111111",2));//0111 1111 1111 1111 1111 1111 1111 1111
    System.out.println("最大值转二进制："+Integer.toBinaryString(Integer.MAX_VALUE));

    System.out.println("最小值       ："+Integer.MIN_VALUE);
    System.out.println("二进制转最小值："+Integer.parseUnsignedInt("10000000000000000000000000000000",2));//1000 0000 0000 0000 0000 0000 0000 0000
...
最小值       ：-2147483648
二进制转最小值：-2147483648
最小值转二进制：10000000000000000000000000000000	//1000 0000 0000 0000 0000 0000 0000 0000
```
